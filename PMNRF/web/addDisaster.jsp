                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a class="active" href="forms.html"><i class="fa fa-edit fa-fw"></i> New Disaster</a>
                            </li>
                            
                            <li>
                                <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Delete Disaster</a>
                            </li>
                            
                            
                            <li>
                                <a href="#"><i class="fa fa-wrench fa-fw"></i> Certificates<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
